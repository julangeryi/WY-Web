...
public interface UpLoadDao {
	 ...
	 * 
	 */
	public List<UpLoadEntity> getByUpLoadUserName(@Param("upLoadUser") String upLoadUser,@Param("upLoadClassify") String upLoadClassify, @Param("deleteFlag") int deleteFlag);
	
	public void insertUpLoad(@Param("upLoadName") String upLoadName,@Param("upLoadDate") String upLoadDate,	@Param("upLoadUser") String upLoadUser,	@Param("upLoadPath") String upLoadPath,	@Param("upLoadClassify") String upLoadClassify);
